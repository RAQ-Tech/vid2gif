...
# -------- Paths & setup --------
# Allow overriding default locations via environment variables to make the
# application more flexible when deployed in different environments.
...
DEFAULTS = {
    "height": 360,   # using HEIGHT (scale keeps aspect via -1:HEIGHT)
    "fps": 15,
    "clip_len": 3.0,
