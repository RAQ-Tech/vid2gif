...
DEFAULT_VIDEO_PREVIEW_REPAIR_ROOT = os.getenv(
    "VIDEO_PREVIEW_REPAIR_ROOT", f"{DEFAULT_QUARANTINE_ROOT}/video-preview-repairs"
)
DEFAULT_SUBTITLE_QUARANTINE_ROOT = f"{DEFAULT_QUARANTINE_ROOT}/subtitles"
...
def default_settings():
    return {
        ...
        "video_preview_repair_root": DEFAULT_VIDEO_PREVIEW_REPAIR_ROOT,
        "subtitle_quarantine_root": DEFAULT_SUBTITLE_QUARANTINE_ROOT,
...
def _coerce_settings(data):
    ...
    return {
        ...
        "video_preview_repair_root": repair_root or defaults["video_preview_repair_root"],
        "subtitle_quarantine_root": subtitle_root or defaults["subtitle_quarantine_root"],
        ...
        "duplicate_subtitle_close_points": _bounded_int(
            data.get("duplicate_subtitle_close_points", defaults["duplicate_subtitle_close_points"]),
            defaults["duplicate_subtitle_close_points"],
            0,
            100,
        ),
        "duplicate_image_close_ratio": _bounded_int(
            data.get("duplicate_image_close_ratio", defaults["duplicate_image_close_ratio"]),
            defaults["duplicate_image_close_ratio"],
            0,
            100,
        ),
        "duplicate_runtime_tolerance_seconds": _bounded_int(
            data.get("duplicate_runtime_tolerance_seconds", defaults["duplicate_runtime_tolerance_seconds"]),
            defaults["duplicate_runtime_tolerance_seconds"],
            0,
            3600,
        ),
