...
Current state: 578 Python tests, all of which pass on CI with none skipped; a
Windows checkout runs 569 of them, since nine need symlinks or media tools. 22
...
an enforced 120-column limit), `ruff format --check` is clean, coverage is 83.20%
